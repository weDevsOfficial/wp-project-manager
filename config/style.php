...
return [
    ...
    'pm-slicknav' => [
        ...
        'dependency' => false,
        'path'       => $wedevs_pm_view_path . '/assets/css/slicknav/slicknav.min.css',
    ],
    'pm-const-style' => [
        'id'         => 'pm-const-style',
