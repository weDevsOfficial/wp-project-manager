<div>
    <ul class="cpm-todos cpm-todolist-content" >
        ...
        <li v-for="task in incomplete_task ">
                ...
                <div class="cpm-todo-content" >
                    ...
                    <div>
                        <div class="cpm-col-7">
                            ...
                            <span class="cpm-todo-text"> <a href="#" @click.prevent="taskDetails( current_project, task.ID )"> {{task.post_title}} </a> </span>
    ...
    <div>
        <ul  class="cpm-todos cpm-todolist-content" >
            <li v-for="task in completed_task " >
