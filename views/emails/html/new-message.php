...
<?php echo $creator ?>
        ...
        <div style="font-family: arial; font-size: 14px; line-height: 24px; color: #7e7e7e;">
            <span style="float: left;  width: 70px;">
                <em style="font-family: lato; color: #B3B3B3; "><?php _e( 'Title', 'pm' ); ?></em>
            </span>
...
<?php echo $title; ?>
            ...
            <span style="float: left;  width: 70px;"><em style="font-family: lato; color: #B3B3B3; "><?php _e( 'Message', 'pm' ); ?></em></span>
        ...
        <div style="padding: 18px; margin: 30px 0 45px; border-radius: 30px; background: #00b1e7; width: 171px; text-align: center;">
