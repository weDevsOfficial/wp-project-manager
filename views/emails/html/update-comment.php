...
<?php esc_html_e( 'Update Comment', 'wedevs-project-manager' ); ?>
            </div>
        </div>
    ...
    <div style="padding: 0 50px; text-align: justify; background-repeat: no-repeat; ">
        <div style="margin: 40px 0 10px; margin-bottom: 20px;">
            <em style="font-family: lato; color: #B3B3B3;padding-right: 5px;"><?php esc_html_e( 'Commented By', 'wedevs-project-manager' ); ?></em>
            <strong style="font-family: lato; color: #7e7e7e; padding-right: 10px;">
<?php echo esc_html($updater); ?>
            </strong>
            <em style="font-family: lato; color: #B3B3B3; "><?php esc_html_e( 'On', 'wedevs-project-manager' ); ?></em>
            <strong style="font-family: lato; color: #7e7e7e;">
                <span style="padding-right: 5px;"><?php echo esc_html($commnetable_type); ?></span><a style="text-decoration: none; font-family: lato; color: #00b1e7; " href="<?php echo esc_url($comment_link );?>"><?php echo esc_html($commnetable_title); ?></a>
            </strong>
        </div>
...
<?php esc_html_e( 'View Comment', 'wedevs-project-manager' ); ?>
        </a>
