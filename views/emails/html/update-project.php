        ...
        <div style="width: 600px;">
            ...
            <div style="padding: 0 50px; text-align: justify; background-repeat: no-repeat;">
                ...
                <div style="font-family: arial; font-size: 14px; line-height: 24px; color: #7e7e7e;">
                    ...
                    <div><?php printf( __( 'You are assigned to a project update "%s" by %s.', 'pm' ), '<b>'.$data['title'].'</b>',  $data['creator']['data']['display_name']  ) ?></div>
                    <div><?php _e( 'You can see the project by going here:', 'pm' ); ?>
                        <a style="text-decoration: none; color: #00b1e7;" href="<?php echo $link . '#/'.$data["id"].'/overview'; ?>"><?php echo $data['title']; ?></a>
