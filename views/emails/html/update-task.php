...
<?php esc_html_e( 'Update task has been assigned to you', 'wedevs-project-manager' ); ?>
            </div>
        </div>

        <div style="padding: 0 50px; text-align: justify; background-repeat: no-repeat;">
            <div style="margin: 40px 0 20px;">
                <em style="font-family: lato; color: #B3B3B3;padding-right: 5px;"><?php esc_html_e( 'Updated By', 'wedevs-project-manager' ); ?></em>
