...
if ( function_exists( 'wedevs_pm_pro_get_logo' ) ) {
    ...
    $wedevs_pm_logo_path = ! empty( $wedevs_pm_logo_path['url'] ) ? $wedevs_pm_logo_path['url'] : null;

    if ( ! empty( $wedevs_pm_logo_path ) ) {
        ?>
                    ...
                    <tr>
                        ...
                        <td align="left" valign="middle" width="50%" style="line-height: 0;">
                            <a style="display: inline-block;text-decoration: none;line-height: 0;" href="<?php echo esc_url( home_url() ); ?>">
                                <img style="width: 100px;"  src="<?php echo esc_url( $wedevs_pm_logo_path ); ?>" alt="<?php echo esc_html( get_bloginfo( 'name' ) ); ?>" title="<?php echo esc_html( get_bloginfo( 'name' ) ); ?>"  />
                            </a>
                        </td>
                    </tr>
                </table>
