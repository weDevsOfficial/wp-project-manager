...
export default function CategoriesPage() {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      toast.error(__("Failed to delete category"));
    }
  };
  ...
  const handleBulkDelete = async () => {
    ...
    try {
      ...
      setSelected(new Set());
      toast.success(__("Categories deleted"));
    } catch {
      toast.error(__("Failed to delete categories"));
    }
  };
      ...
      {loading ? (
        ...
        <div className="rounded-xl border bg-card overflow-hidden">
          ...
          <div className="grid grid-cols-12 gap-4 items-center px-4 py-2.5 bg-muted/30 border-b text-[14px] font-semibold uppercase tracking-wider text-pm-text-muted/70">
            ...
            <div className="col-span-2 text-right">{__("Actions")}</div>
          </div>
      ...
      <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
            <div className="space-y-2">
              <Label>
                {__("Name")} <span className="text-destructive">*</span>
              </Label>
              <Input
                value={formTitle}
