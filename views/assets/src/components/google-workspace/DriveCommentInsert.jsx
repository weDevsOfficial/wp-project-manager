...
export default function DriveCommentInsert({ projectId, onInsert }) {
  ...
  return (
    <>
      <Button type="button" variant="ghost" size="icon" className="h-7 w-7 text-pm-text-muted hover:text-pm-accent" title={__('Add Google Drive file', 'wedevs-project-manager')} aria-label={__('Add Google Drive file', 'wedevs-project-manager')} onClick={openPicker}>
