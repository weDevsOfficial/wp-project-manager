...
// Multicolor Google Drive logo for the nav.
...
export function AppSidebar() {
  ...
  const viewNavItems = useMemo(() => {
    ...
    items.push({ key: 'google-workspace', label: __('Google Workspace', 'wedevs-project-manager'), short: __('Drive', 'wedevs-project-manager'), icon: GoogleDriveNavIcon, route: '/google-workspace' })
    return items
