<template>
    <div class="wpuf-integration" v-if="hasSlack">
        <div :class="'wpuf-panel'  + ' ' + isActive">
            <div class="wpuf-panel-body">
                <img class="icon" :src="getAssetUrl( '/images/icon-slack.svg' )" :alt="'Slack'">
            </div>
        ...
        <div id="slack" role="dialog" class="wf-modal">
                ...
                <div class="wf-modal-content">
                    <div class="wf-modal-header">
                        <div class="modal-header-left">
                            ...
                            <img height="30px"
                                :src="getAssetUrl( '/images/icon-slack.svg' )"
                                alt="Slack"
                                class="icon"
                            >
                        </div>
                        ...
                        <div>
                            <div>
                                <div class="wpuf-int-form-row">
                                    <div class="wpuf-int-field-label"><label for="mailchimp-list-id">Slack Webhook URL</label></div>
                                    <div class="wpuf-int-field">
                                                                        <input v-model="slack.webhook" type="url" placeholder="https://hooks.slack.com/services/..." class="regular-text">
                            <p class="help">
                                ...
                                (<a href="https://wedevs.com/docs/wp-project-manager/integrations/slack/" target="_blank">
                                    {{ __( 'View documentation', 'wedevs-project-manager') }}
                                </a>)
                            </p>

                            <a @click.prevent="showHideMoreOption()" href="#">

                                <span v-if="!isActiveMoreOption"><i class="fa fa-plus-circle" aria-hidden="true"></i></span>
                                <span v-if="isActiveMoreOption"><i class="fa fa-minus-circle" aria-hidden="true"></i></span>
                                {{ __( 'More option', 'wedevs-project-manager') }}
                            </a>

                            <div class="pm-pro-slack-more-option" v-if="isActiveMoreOption">
                                <div>
                                    <h3 class="pm-pro-slack-field-set">
                                        <!-- <i class="fa fa-tasks" aria-hidden="true"></i> -->
                                        {{ __( 'Tasks', 'wedevs-project-manager' ) }}
                                    </h3>
                                    <div class="pm-pro-slack-field">
                                        <div class="pm-pro-slack-field-wrap pm-pro-slack-field-wrap-right">
                                            <input type="checkbox" v-model="slack.options.tasks.create" id="slack-task-create-box">
                                            <label for="slack-task-create-box">
                                                {{ __( 'Create', 'wedevs-project-manager' ) }}
                                            </label>
                                        </div>

                                        <div class="pm-pro-slack-field-wrap pm-pro-slack-field-wrap-left">
                                            <input v-model="slack.options.tasks.update" type="checkbox" id="slack-task-update-box">
                                            <label for="slack-task-update-box">
                                    ...
                                    <div class="pm-pro-slack-field">
                                        <div class="pm-pro-slack-field-wrap pm-pro-slack-field-wrap-right">
                                            <input v-model="slack.options.tasks.complete" type="checkbox" id="slack-task-done-box">
                                            <label for="slack-task-done-box">
                                                {{ __( 'Complete', 'wedevs-project-manager' ) }}
                                            </label>
                                        </div>

                                        <div class="pm-pro-slack-field-wrap pm-pro-slack-field-wrap-left">
                                            <input v-model="slack.options.tasks.incomplete" type="checkbox" id="slack-task-undone-box">
                                            <label for="slack-task-undone-box">
                                     ...
                                     <div class="pm-pro-slack-field">
                                        <div class="pm-pro-slack-field-wrap pm-pro-slack-field-wrap-right">
                                            <input v-model="slack.options.tasks.createComment" type="checkbox" id="slack-task-comment-box">
                                            <label for="slack-task-comment-box">
                                                {{ __( 'New comment', 'wedevs-project-manager' ) }}
                                            </label>
                                        </div>

                                        <div class="pm-pro-slack-field-wrap pm-pro-slack-field-wrap-left">
                                            <input v-model="slack.options.tasks.updateComment" type="checkbox" id="slack-task-update-comment-box">
                                            <label for="slack-task-update-comment-box">
                                ...
                                <pm-do-action :hook="'pm-pro-after-slack-more-options'" :actionData="slack"></pm-do-action>
        ...
        computed: {
            ...
            hasSlack () {
                ...
                if(slack && !jQuery.isEmptyObject(slack)) {
                    this.slack = Object.assign(this.slack, slack );
