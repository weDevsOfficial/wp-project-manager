...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_header_vue__ = __webpack_require__(143);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_common_do_action_vue__ = __webpack_require__(21);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    components: {
        'pm-header': __WEBPACK_IMPORTED_MODULE_1__common_header_vue__["a" /* default */],
        'do-action': __WEBPACK_IMPORTED_MODULE_2__components_common_do_action_vue__["a" /* default */]
    },

    created() {
        //this.$store.commit('ketumi');
        //console.log(this.$store.state);
        //console.log(fuck);
        this.ketumi();
    },
    computed: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_vuex__["mapState"])('account/myPage/myname', {
        test(state) {
            console.log(state);
        },
        ...
        files() {
            ...
            return 'mishu'; //store.state.pmfiles.files;
        }
    }),
    ...
    methods: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_vuex__["mapMutations"])('account/myPage/myname', [function (state) {
        console.log(state);
    }])
