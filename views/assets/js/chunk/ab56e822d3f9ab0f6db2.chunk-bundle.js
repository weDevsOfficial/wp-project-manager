...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_activities_vue__ = __webpack_require__(194);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0a6136d9_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_activities_vue__ = __webpack_require__(245);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0a6136d9_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_activities_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "views/assets/js/src/activities/activities.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0a6136d9", Component.options)
  } else {
    hotAPI.reload("data-v-0a6136d9", Component.options)
  }
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._m(0)]) : _c('div', [(_vm.activities.length) ? _c('ul', {
    ...
    return _c('li', {
    ...
    }, [_c('span', [_vm._v(_vm._s(_vm.actiivtyGroupDate(group.date, 'DD')))]), _vm._v(" "), _c('br'), _vm._v("\n                    " + _vm._s(_vm.actiivtyGroupDate(group.date, 'MMMM')) + "\n                     \n                ")]), _vm._v(" "), _c('div', {
      staticClass: "pm-activity-body pm-col-11 pm-sm-col-12 pm-right pm-last-col"
    }, [_c('ul', _vm._l((group.activities), function(activity) {
      return _c('li', [_c('div', {
      ...
      }, [_vm._v("\n                                    " + _vm._s(activity.actor.data.display_name) + "\n                                ")]), _vm._v(" "), _c('span', {
        domProps: {
        ...
        attrs: {
          "datetime": _vm.pmDateISO8601Format(activity.committed_at.date, activity.committed_at.time),
          "title": _vm.pmDateISO8601Format(activity.committed_at.date, activity.committed_at.time)
        }
      }, [_vm._v("\n                                    " + _vm._s(activity.committed_at.date) + " " + _vm._s(activity.committed_at.time) + "\n                                ")])]), _vm._v(" "), _c('div', {
        staticClass: "clear"
      })])
    }))])])
  })) : _vm._e(), _vm._v(" "), (_vm.total_activity > _vm.loaded_activities) ? _c('a', {
  ...
  }, [_vm._v(_vm._s(_vm.text.load_more))]) : _vm._e(), _vm._v(" "), _c('span', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.show_spinner),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0a6136d9", esExports)
  }
}
