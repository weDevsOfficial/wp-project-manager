...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_discussions_vue__ = __webpack_require__(196);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2ad4d991_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_discussions_vue__ = __webpack_require__(250);
var disposed = false
var normalizeComponent = __webpack_require__(1)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2ad4d991_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_discussions_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "views/assets/js/src/discussions/discussions.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2ad4d991", Component.options)
  } else {
    hotAPI.reload("data-v-2ad4d991", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "pm-blank-template discussion"
  }, [_c('div', {
    staticClass: "pm-content"
  }, [_c('h3', {
    staticClass: "pm-page-title"
  }, [_vm._v(_vm._s(_vm.text.discussions))]), _vm._v(" "), _c('p', [_vm._v("\n                " + _vm._s(_vm.text.discuss_define) + "\n            ")]), _vm._v(" "), _c('div', [_c('a', {
    staticClass: "pm-btn pm-plus-white pm-new-message-btn pm-btn-uppercase",
    attrs: {
      "href": "",
      "id": "pm-add-message"
    },
  ...
  }, [(_vm.is_discuss_form_active) ? _c('div', {
    staticClass: "pm-new-message-form"
  }, [_c('h3', [_vm._v(_vm._s(_vm.text.create_a_new_message))]), _vm._v(" "), _c('new-discuss-form', {
    attrs: {
      "discuss": {}
    }
  ...
  }, [_vm._v(" " + _vm._s(_vm.text.when_use_discuss) + " ")]), _vm._v(" "), _c('ul', {
    staticClass: "pm-list"
  }, [_c('li', [_vm._v(" " + _vm._s(_vm.text.to_discuss_work_matter) + " ")]), _vm._v(" "), _c('li', [_vm._v(" " + _vm._s(_vm.text.to_exchange_file))]), _vm._v(" "), _c('li', [_vm._v(" " + _vm._s(_vm.text.to_discuss_group))]), _vm._v(" "), _c('li', [_vm._v(" " + _vm._s(_vm.text.to_open_discuss) + " ")])])])], 1)]) : _vm._e(), _vm._v(" "), (_vm.discussTemplate) ? _c('div', [_c('div', {
    ...
    staticClass: "pm-form pm-new-message-form pm-col-6 pm-sm-col-12"
  }, [_c('h3', [_vm._v(_vm._s(_vm.text.create_a_new_message))]), _vm._v(" "), _c('new-discuss-form', {
    attrs: {
      "discuss": {}
    }
  })], 1) : _vm._e()])], 1), _vm._v(" "), _c('div', {
    staticClass: "pm-row pm-message-page"
  }, [_c('div', {
    staticClass: "pm-message-list pm-col-12 pm-sm-col-12"
  }, [_c('div', {
    staticClass: "pm-box-title"
  }, [_vm._v(_vm._s(_vm.text.discussion_list))]), _vm._v(" "), _c('ul', {
    staticClass: "dicussion-list"
  }, _vm._l((_vm.discussion), function(discuss) {
    return _c('li', {
      key: "discuss.id",
      staticClass: "pm-col-12"
    }, [_c('div', {
      ...
      staticClass: "pm-col-2 pm-last-col pm-right comment-count"
    }, [_c('router-link', {
      staticClass: "pm-pagination-btn prev page-numbers",
      attrs: {
        "to": {
    ...
    }, [_vm._v("\n                                " + _vm._s(discuss.meta.total_comments) + " " + _vm._s(_vm.text.comments) + " \n                            ")])], 1), _vm._v(" "), _c('div', {
      staticClass: "clear"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-2ad4d991", esExports)
  }
}
