...
;(function ($, window, document, undefined) {
    ...
    var methods = {
        remove: function (class_name) {
            var loader = $(this).find('.zapierintegration');
            console.log($(this), loader, class_name);
            if ($preloader) {
                isInited = false;
                //$preloader.remove();
            }
    ...
    Plugin.prototype.init = function () {
        ...
        element.prepend('<div class="preloader ' + class_name + '"><div class="preloader-container"><div class="preloader-animation"></div></div></div>');
