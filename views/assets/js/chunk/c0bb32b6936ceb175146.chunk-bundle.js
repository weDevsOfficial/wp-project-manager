...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_overview_vue__ = __webpack_require__(208);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_bb64a44e_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_overview_vue__ = __webpack_require__(269);
var disposed = false
var normalizeComponent = __webpack_require__(2)
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_bb64a44e_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_overview_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "views/assets/js/src/overview/overview.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-bb64a44e", Component.options)
  } else {
    hotAPI.reload("data-v-bb64a44e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "pm-col-10 pm-sm-col-12"
  }, [_c('div', {
    ...
    staticClass: "count"
  }, [_c('span', [_vm._v(_vm._s(_vm.meta.total_discussion_boards))]), _vm._v(" \n\t\t\t         \t\t\t\t" + _vm._s(_vm.text.discussions) + "\n\t\t\t         \t\t\t")])])], 1), _vm._v(" "), _c('li', {
    staticClass: "todo"
  }, [_c('router-link', {
    attrs: {
      "to": {
    ...
    staticClass: "count"
  }, [_c('span', [_vm._v(_vm._s(_vm.meta.total_task_lists))]), _vm._v(" \n\t\t\t         \t\t\t\t" + _vm._s(_vm.text.task_lists) + "\n\t\t\t         \t\t\t")])])], 1), _vm._v(" "), _c('li', {
    staticClass: "todos"
  }, [_c('a', {
    attrs: {
    ...
    staticClass: "count"
  }, [_c('span', [_vm._v(_vm._s(_vm.meta.total_tasks))]), _vm._v(" \n\t\t\t         \t\t\t" + _vm._s(_vm.text.tasks) + "\n\t\t\t         \t\t")])])]), _vm._v(" "), _c('li', {
    staticClass: "comments"
  }, [_c('a', [_c('div', {
    staticClass: "icon"
  }), _vm._v(" "), _c('div', {
    staticClass: "count"
  }, [_c('span', [_vm._v(_vm._s(_vm.meta.total_comments))]), _vm._v("  \n\t\t\t\t\t         \t\t" + _vm._s(_vm.text.comments) + "\n\t\t\t\t\t         \t")])])]), _vm._v(" "), _c('li', {
    staticClass: "files"
  }, [_c('router-link', {
    attrs: {
      "to": {
    ...
    staticClass: "count"
  }, [_c('span', [_vm._v(_vm._s(_vm.meta.total_files))]), _vm._v("  \n\t\t\t\t\t\t    \t\t\t" + _vm._s(_vm.text.files) + "\n\t\t\t\t\t\t    \t")])])], 1), _vm._v(" "), _c('li', {
    ...
    staticClass: "count"
  }, [_c('span', [_vm._v(_vm._s(_vm.meta.total_milestones))]), _vm._v(" \n\t\t\t\t\t\t\t\t\t\t" + _vm._s(_vm.text.milestones) + "\n\t\t\t\t\t\t\t\t")])])], 1), _vm._v(" "), _c('div', {
    staticClass: "clearfix"
  })])]), _vm._v(" "), _c('div', {
    staticClass: "pm-chart",
    attrs: {
      "id": "pm-chart"
    }
  }, [_c('h3', [_vm._v(_vm._s(_vm.text.this_month))]), _vm._v(" "), _c('canvas', {
    directives: [{
    ...
    staticClass: "pm-border-bottom"
  }, [_vm._v(" " + _vm._s(_vm.text.users) + " ")]), _vm._v(" "), _c('ul', {
    ...
    }, [_vm._v("\n\t\t\t\t\t\t\t" + _vm._s(user.display_name) + "\n\t\t\t\t\t\t")]), _vm._v(" "), _vm._l((user.roles.data), function(role) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-bb64a44e", esExports)
  }
}
