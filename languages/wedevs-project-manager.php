...
return [
	...
	__( 'Filter by user', 'wedevs-project-manager' ),
	__( 'Md. Sifatullah Kakkar', 'wedevs-project-manager' ),
	...
	__( 'Click Me', 'wedevs-project-manager' ),
	...
	__( 'Add new subtask (character limit 200)', 'wedevs-project-manager' ),
	...
	__( 'Add estimation time', 'wedevs-project-manager' ),
	...
	__( 'Update comment', 'wedevs-project-manager' ),
	__( 'Custom field will help you to create additional<br/>fields for this task. Create a custom field<br/>from project settings. ⭐️ This feature is available<br/>on Pro version', 'wedevs-project-manager' ),
	...
	__( 'Generate a report based on <strong>tasks</strong> which are <strong>pending</strong> beyond due dates.', 'wedevs-project-manager' ),
	__( 'View Full Report', 'wedevs-project-manager' ),
	__( 'Generate a report from <strong>tasks</strong> which were <strong>completed</strong>.', 'wedevs-project-manager' ),
	__( 'User Activities', 'wedevs-project-manager' ),
	__( 'Create a report based on an employee or <strong>all employee</strong> activity on <strong>tasks</strong>.', 'wedevs-project-manager' ),
	__( 'Task by Milestone', 'wedevs-project-manager' ),
	__( 'Browse   <strong>tasks</strong> reports according to <strong>Milestones</strong> (CSV exportable).', 'wedevs-project-manager' ),
	__( 'Unassigned Task', 'wedevs-project-manager' ),
	__( 'Find out <strong>all tasks</strong> whichwere not  <strong>assigned</strong> to any employee.', 'wedevs-project-manager' ),
	...
	__( 'Canvas Image', 'wedevs-project-manager' ),
	__( 'Task Types', 'wedevs-project-manager' ),
	__( 'Subtask Types', 'wedevs-project-manager' ),
	__( 'Please add <mark>Estimation time</mark> for sub tasks to get the list !', 'wedevs-project-manager' ),
	__( 'Completed At', 'wedevs-project-manager' ),
	...
	__( 'Close Icon', 'wedevs-project-manager' ),
	__( 'Diamond Icon', 'wedevs-project-manager' ),
	...
	__( 'Check Icon', 'wedevs-project-manager' ),
