...
return [
	...
	__( 'Get month/week/day wise overview of your added task in your project manager.', 'wedevs-project-manager' ),
	...
	__( 'Get upgraded to Pro version to unlock endlless opppurtunities of managing your project better.', 'wedevs-project-manager' ),
	__( 'Upgrade to Pro', 'wedevs-project-manager' ),
	__( 'Enhance your project management performance with its extended features in the pro version.', 'wedevs-project-manager' ),
	__( 'View Pro features', 'wedevs-project-manager' ),
	__( 'Check out all its useful modules that would take your project management experience to a whole new level.', 'wedevs-project-manager' ),
