...
$wedevs_pm_router->get( 'projects/{project_id}/activities', [\WeDevs\PM\Activity\Controllers\Activity_Controller::class, 'index'] )
    ->permission( [ $wedevs_pm_access_project ] );

$wedevs_pm_router->get( 'activities', [\WeDevs\PM\Activity\Helper\Activity::class, 'get_activities'] )
