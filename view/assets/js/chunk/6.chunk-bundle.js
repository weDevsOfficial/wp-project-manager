    ...
    [
      ...
      _c("div", [
        _c(
          ...
          {
            staticClass:
              "cpm-btn cpm-plus-white cpm-new-message-btn cpm-btn-uppercase",
            attrs: { href: "", id: "cpm-add-message" },
            on: {
              click: function($event) {
                $event.preventDefault()
      ...
      _vm.is_discuss_form_active
        ? _c(
            ...
            [
              _c("h3", [_vm._v("Create a new message")]),
              _vm._v(" "),
        ...
        : _vm._e(),
      _vm._v(" "),
      _c("div", { staticClass: "cpm-row cpm-message-page" }, [
        _c(
          "div",
          { staticClass: "cpm-message-list cpm-col-12 cpm-sm-col-12" },
          [
            _c("div", { staticClass: "cpm-box-title" }, [
              _vm._v("Discussion List")
            ]),
            _vm._v(" "),
            _c(
              "ul",
              ...
              _vm._l(_vm.discussion, function(discuss) {
                return _c(
                  "li",
                  { key: "discuss.id", staticClass: "cpm-col-12" },
                  [
                    _c(
                      "div",
                    ...
                    _c("div", { staticClass: "cpm-col-1" }, [
                      _c(
                        ...
                        [
                          _c("a", {
                            staticClass:
                              "cpm-msg-edit dashicons dashicons-edit",
                            attrs: { href: "#" },
                            on: {
                              click: function($event) {
                                $event.preventDefault()
                          ...
                          _vm._v(" "),
                          _c("span", { staticClass: "cpm-unlock" })
                        ]
                      )
                    ]),
                    _vm._v(" "),
                    ...
                    _vm._v(" "),
                    discuss.edit_mode
                      ? _c("new-discuss-form", { attrs: { discuss: discuss } })
                      : _vm._e()
                  ],
                  1
                )
