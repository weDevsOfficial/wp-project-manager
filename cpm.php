...
class WeDevs_CPM {
    ...
    static function admin_scripts() {
        ...
        wp_register_script( 'cpm-task-components', CPM_URL . '/assets/js/task-components.js', array ( 'jquery', 'cpm-vue-multiselect', 'cpm-tiny-mce-component', 'cpm-toastr' ), false, true );
